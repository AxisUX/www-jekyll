...
![Check ESX Version]({{ "assets/images/update-esxi-6.0-to-6.7-via-cli/check-version-and-enable-ssh.png" | absolute_url }})

#### Enable SSH

Under Software settings select Security Profile

![Enable SSH on ESXi]({{ "assets/images/update-esxi-6.0-to-6.7-via-cli/enable-ssh.png" | absolute_url }})

#### Open Security Profile Properties

![Open ESXi Security Profile Properties]({{ "assets/images/update-esxi-6.0-to-6.7-via-cli/open-security-profile-properties.png" | absolute_url }})

#### Located the SSH service

Locate the SSH service and click 'Options'

![Locate ESXi SSH Service and Click Options]({{ "assets/images/update-esxi-6.0-to-6.7-via-cli/located-the-ssh-service.png" | absolute_url }})

#### Start the SSH Service 

![Start the ESXi SSH Service]({{ "assets/images/update-esxi-6.0-to-6.7-via-cli/start-the-ssh-service-.png" | absolute_url }})
...
[https://docs.vmware.com/en/VMware-vSphere/6.7/rn/vsphere-esxi-vcenter-server-67-release-notes.html#installupgrade](https://docs.vmware.com/en/VMware-vSphere/6.7/rn/vsphere-esxi-vcenter-server-67-release-notes.html#installupgrade) 
...
[root@ESXi:~] esxcli software sources profile list -d [https://hostupdate.vmware.com/software/VUM/PRODUCTION/main/vmw-depot-index.xml](https://hostupdate.vmware.com/software/VUM/PRODUCTION/main/vmw-depot-index.xml) | grep -i ESXi-6.7
...
[root@ESXi:~] esxcli software profile update -p ESXi-6.7.0-8169922-standard -d [https://hostupdate.vmware.com/software/VUM/PRODUCTION/main/vmw-depot-index.xml](https://hostupdate.vmware.com/software/VUM/PRODUCTION/main/vmw-depot-index.xml)
...
DC
   ...
   Config File: /vmfs/volumes/4faac78b-87d2b646-3436-001018da65d2/Camp-DC/Camp-DC.vmx
...
esxcli vm process kill --type=soft --world-id=35508

esxcli vm process kill --type=soft --world-id=35264
